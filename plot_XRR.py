...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dcc.Slider( 5, 300, step=None, id='fit_energy--slider', value=10 ),
...
@callback(
    ...
    Input(component_id='fit_energy--slider', component_property='value'),
    ...
    Input(component_id='fit_delta--slider', component_property='value'),    
    Input(component_id='fit_beta--slider', component_property='value'),    
)
def update_graph(energy,thickness, rough,delta,beta):    
    #print(order)
    ...
    n = np.array([1 + 0 * 1j,1-delta+beta*1j,nk_sub_oxid,nk_sub])
